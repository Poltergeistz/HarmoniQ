<section id="demo" class="bg-primary py-20 text-center">
	<div class="mx-auto max-w-6xl">
		<h2 class="my-8 text-3xl font-black text-white black uppercase">Demo</h2>

		<!-- Video Mockup -->
		<div
			class="relative mx-auto w-full max-w-4xl rounded-2xl bg-gradient-to-r from-white via-lime-100 to-lime-200 p-2 shadow-xl"
		>
			<div
